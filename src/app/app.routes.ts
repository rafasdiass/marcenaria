...
import { ProductConfigurationComponent } from './content/components/product-configuration/product-configuration/product-configuration.component';
import { ProductSelectionComponent } from './content/components/product-selection/product-selection/product-selection.component';
...
import { RoomComponent } from './content/components/rooms/room/room.component';
import { SummaryComponent } from './content/components/summary/summary/summary.component';
import { CartComponent } from './content/components/cart/cart/cart.component';
